...
void spi_config(void)
{
    ...
    // spi_init_struct.prescale             = SPI_PSC_8;       // TODO check faster speeds
    spi_init_struct.prescale             = SPI_PSC_4;       // TODO check faster speeds
...
void LCD_ShowChar(u16 x, u16 y, u8 num, u8 mode, u16 color)
{
    ...
    u8 pos, t;
    u16 x0 = x;
    if (x > _width - 8 || y > _height - 16)return; //设置窗口
    num = num - ' '; //得到偏移后的值
